 ...
 */
export type PaymentMethodSelectionHandler = (paymentIntent: PaymentIntent.Type, availablePaymentOptions: PaymentOption[], callback: {
    selectPaymentOption: (paymentOptionType: string) => Promise<{
        error?: StripeError;
    }>;
    failPaymentMethodSelection: (error?: string) => Promise<{
        error?: StripeError;
    }>;
}) => void;
/**
 ...
 */
export type QrCodeDisplayHandler = (paymentIntent: PaymentIntent.Type, qrData: QrCodeDisplayData, callback: {
    confirmQrCodeDisplayed: () => Promise<{
        error?: StripeError;
    }>;
    failQrCodeDisplay: (error?: string) => Promise<{
        error?: StripeError;
    }>;
}) => void;
 ...
 * Configures localization of API error messages returned by the React Native SDK.
 */
export type LocaleConfig = HardcodedLocaleConfig | CardLanguagePreferenceLocaleConfig;
/**
...
export type DiscoverReadersParams = DiscoverBluetoothScanParams | DiscoverBluetoothProximityParams | DiscoverInternetParams | DiscoverUsbParams | DiscoverAppsOnDevicesParams | DiscoverTapToPayParams;
...
export type DiscoveryFilter = DiscoveryFilterNone | DiscoveryFilterReaderId | DiscoveryFilterSerialNumber;
...
export type EasyConnectParams = EasyConnectInternetParams | EasyConnectTapToPayParams | EasyConnectAppsOnDevicesParams;
...
export declare enum AppTransitionPreset {
...
export type ConnectReaderParams = ConnectBluetoothReaderParams | ConnectBluetoothProximityReaderParams | ConnectUsbReaderParams | ConnectTapToPayParams | ConnectAppsOnDevicesParams | ConnectInternetReaderParams;
...
export type PaymentStatus = 'notReady' | 'ready' | 'processing' | 'waitingForInput';
/**
...
export declare const PaymentMethodType: {
    readonly Card: "card";
    readonly CardPresent: "cardPresent";
    readonly InteracPresent: "interacPresent";
...
export type RefundParams = RefundParamsWithPaymentIntentId | RefundParamsWithChargeId;
...
export type ConnectionStatus = 'notConnected' | 'connecting' | 'connected' | 'discovering' | 'reconnecting';
/**
 * @ignore
 */
...
export declare enum SelectionButtonStyle {
    PRIMARY = "primary",
    SECONDARY = "secondary"
}
...
export declare enum ToggleValue {
    ENABLED = "enabled",
    DISABLED = "disabled"
}
export declare enum ToggleResult {
    ENABLED = "enabled",
    DISABLED = "disabled",
    SKIPPED = "skipped"
}
...
export declare enum CollectDataType {
    MAGSTRIPE = "magstripe",
    NFC_UID = "nfcUid",
    UNKNOWN = "unknown"
}
...
export type CustomerCancellation = 'enableIfAvailable' | 'disableIfAvailable' | 'unspecified';
export type TapToPayUxConfiguration = {
    tapZone?: TapZone;
    darkMode?: DarkMode;
    colors?: Colors;
};
export type TapZone = TapZoneDefault | TapZoneAbove | TapZoneBelow | TapZoneFront | TapZoneBehind | TapZoneLeft | TapZoneRight;
