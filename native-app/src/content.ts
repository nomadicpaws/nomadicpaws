...
export type InstagramPostDraft = { id: string; title: string; caption: string; mediaUrls: string[]; targetDate: string | null; theme: string; status: 'Draft' | 'Ready' | 'Handed Off' | 'Posted'; assignedTo: 'Katie' | 'Trinitie'; handoffNote: string; sharedWithMom: boolean; updatedAt: string }
