...
import { CHEETO_VOICE_GUIDE, biblicalDirectionFor } from './lib/cheeto-voice.mjs'
...
export default async (request: Request) => {
  try {
    ...
    const biblicalDirection = biblicalDirectionFor(theme)
